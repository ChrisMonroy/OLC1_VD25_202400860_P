...
public class AccesoVector2D extends Instruccion {
    ...
    public Object interpretar(Arbol arbol, TablaSimbolos tabla) {
        Simbolo simbolo = tabla.getVariable(id); // o tabla.get(id), pero usa el mismo que en AccesoVector
        if (simbolo == null) {
        ...
        // Establecer tipo de retorno como el tipo base (escalar)
        this.tipo = new Tipo(tipoSimbolo.getTipo());
        return fila[j];
    }
}